///////////////////////////////////////////////////////////////////////
////  Copyright 2020 by mars.     考虑不用异或，使用其他hash函数         //
///////////////////////////////////////////////////////////////////////
...
void PREDICTOR_init(void)
{
	...
	ghr = 0;
	numPhtEntries = (1 << HIST_LEN);    		// 模式历史表，有2^24项
	numLhtEntries = (1 << (HIST_LEN-4));    	// 局部历史表，有2^20项
...
// Gshare分支预测器
// 将PC的低24位，与全局历史寄存器进行异或（加密），去索引PHT，得到对应的饱和状态
// 如果该状态的值超过一半，则预测跳转
// 如果该状态的值低于一半，则预测不跳转
